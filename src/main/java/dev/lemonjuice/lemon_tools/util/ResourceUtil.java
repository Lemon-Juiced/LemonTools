...
public class ResourceUtil {
    ...
    public static rodResource blazeRodResource = new rodResource("blaze_rod", "blaze", Ingredient.of(Items.BLAZE_ROD), 0.0F);
    public static rodResource endRodResource = new rodResource("end_rod", "end", Ingredient.of(Items.END_ROD), 0.0F);
    public static rodResource woodenRodResource = new rodResource("wood", "wooden", Ingredient.of(Items.STICK), 0.0F);
}

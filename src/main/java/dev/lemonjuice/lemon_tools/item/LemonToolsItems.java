...
public class LemonToolsItems {
    ...
    public static final ArrayList<LTSwordItem> SWORD_ITEMS = new ArrayList<>();
    ...
    public static void register(IEventBus eventBus) {
        ...
        ArrayList<LTSwordItem> swordItems = swordItemFactory.createSwordItems();
        for (LTSwordItem swordItem : swordItems) {
            ITEMS.register(swordItem.getSwordName(), () -> swordItem);
            SWORD_ITEMS.add(swordItem);
        }
    }
}
